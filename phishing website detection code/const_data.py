...
modeee = input('please enter phishing dataset or legitimate dataset\n')
FLAGS["mode"] = modeee
targee = input('please enter feature extraction is for training or testing\n')
FLAGS["target"] = targee

data_dir = "HTML/phishing_test" # dataset html files location
database_name = "it352" # this script assumes the relevent urls are in a SQL file. See the example SQL file provided in the repository
table_name = "phishing_test" # name of the database table
